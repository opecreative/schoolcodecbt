...
//update = mysqli_query($con, "UPDATE user SET done = 'yes' WHERE admission = '$user'");
// insert into done table

$done_table = mysqli_query($con, "INSERT INTO done_table (username, subject_id) VALUES('$user', '$sub_id')");
...
$select_total_question = mysqli_query($con, "SELECT * FROM question_bank WHERE sub_id='$sub_id'");
...
<div class="col-md-12">
    ...
    <h3 align="center"><div class="alert alert-info"><i class="fa fa-book"></i> You have successfully submitted your exam.</div></h3>
    ...
    <div align="center"><a href="option.php" class="btn btn-primary">Next Exam</a></div>
